...
var profileSchema = external_exports.object({
  ...
  resumeLink: external_exports.string().optional(),
...
var UpdateProfile = class extends OpenAPIRoute {
  ...
  schema = {
    ...
    description: "Proxies straight through to the backend's PUT /profile. Requires the backend admin JWT \u2014 pass it as the x-admin-token header (in addition to this worker's own bearer token). multipart/form-data body (for an optional new profile image) is forwarded unparsed.",
    parameters: [
      {
        name: "x-admin-token",
        in: "header",
        ...
        content: {
          "multipart/form-data": {
            schema: external_exports.object({
              ...
              location: external_exports.string().optional(),
              resumeLink: external_exports.string().optional(),
              image: external_exports.string().optional().describe("Optional new profile image file.")
            })
          }
        }
      }
        ...
        content: {
          "application/json": {
            schema: external_exports.object({
              ...
              roles: external_exports.array(roleSchema).optional(),
              technologies: external_exports.array(external_exports.string()).optional(),
              order: external_exports.number().optional()
            })
          }
...
var PUBLIC_PATHS = ["/api/docs", "/api/openapi.json", "/api/refresh"];
  ...
  components: {
    securitySchemes: {
      ...
      refreshSecret: {
        ...
        in: "header",
        name: "x-refresh-secret",
        description: "Only used by POST /api/refresh, which is called by the backend and by Cloudflare Cron rather than by end users, so it keeps its own separate shared secret instead of the bearer token above."
      }
    }
  },
  security: [{ bearerAuth: [] }]
...
// .wrangler/tmp/bundle-cxXUha/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-cxXUha/middleware-loader.entry.ts
